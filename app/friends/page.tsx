    ...
    <div className="min-h-screen bg-off-white">
      ...
      <div className="border-b-[3px] border-black bg-lime-green">
        <div className="max-w-7xl mx-auto px-4 py-8">
          <h1 className="font-brutal text-5xl md:text-6xl leading-none">
            👥 THE CREW
          </h1>
          <p className="font-mono text-sm mt-2 opacity-70">
            {loading ? '...' : `All ${friends.length} suspect${friends.length !== 1 ? 's' : ''} on file.`}
          </p>
        </div>
      </div>
      ...
      <main className="max-w-7xl mx-auto px-4 py-8">
        {loading ? (
          <div className="panel-brutal text-center py-20">
            <p className="font-brutal text-2xl animate-pulse">📂 LOADING SUSPECTS...</p>
          </div>
        ) : friends.length === 0 ? (
          <div className="panel-brutal text-center py-20">
            <p className="font-brutal text-2xl">🤷 NO SUSPECTS YET</p>
